...
function Assert-All {
	...
	[object]$Input,
		...
		Mandatory,
		Position = 0,
		HelpMessage = "Assert that every item in the pipeline is equal to this one.")]
		[object]$Eq
	)
...
function Assert-Any {
	...
	[object]$Input,
		...
		Mandatory,
		Position = 0,
		HelpMessage = "Assert that any item in the pipeline is equal to this one.")]
		[object]$Eq
	)
...
function Assert-None {
	...
	[object]$Input,
		...
		Mandatory,
		Position = 0,
		HelpMessage = "Assert that no item in the pipeline is equal to this one.")]
		[object]$Eq
	)
